...
object SparkMovieRecommendation {
  def main(args: Array[String]) {
    ...
    val movies = sc.textFile(new File(movieLensHomeDir, "FurnitureShops.dat").toString).map { line =>
      val fields = line.split("::")
    ...
    println("Got " + numRatings + " ratings from "
      + numUsers + " users on " + numMovies + " FurnitureMalls.")
    ...
    println("FurnitureMalls recommended for you:")
