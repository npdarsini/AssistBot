...
object StreamingTestData {
  ...
  def main(args: Array[String]) {
    ...
    //val tags = List( "bibimap" , "jiaozi", "oden", "omelet", "rice", "sausage", "spaghetti", "sushi", "tempura", "toast" )

    val tags = List( "charger", "keys", "phone", "spects", "watch")
    //List("aeroplane", "cars", "bike", "motorcycle", "bus", "cruise", "train")
    val server = new ServerSocket(2100)
